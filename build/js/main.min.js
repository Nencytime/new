...
/* harmony import */ var _show_more_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_show_more_js__WEBPACK_IMPORTED_MODULE_4__);
...
var allElems = document.querySelectorAll('.type_3 .headingElem');
allElems.forEach(function (elem) {
  elem.addEventListener('click', function () {
    /*находим все активные элементы*/
    var descActive = document.querySelectorAll('.type_3 .descElem.active');
    /*прогоняем через цикл и удаляем класс active*/
    descActive.forEach(function (elem) {
      elem.classList.remove('active');
    });
    var parentElem = this.parentNode;
    var contentBlock = parentElem.querySelector('.descElem');
