    ...
    value: function addEventListener() {
      ...
      this._el.addEventListener('click', function (e) {
        ...
        if (!_this._config.alwaysOpen) {
          var elOpenItem = _this._el.querySelector('.accordion__item-show');
          if (elOpenItem) {
            if (elOpenItem !== elHeader.parentElement) {
              _this.toggle(elOpenItem);
            }
          }
        }
...
var Accordion = new ItcAccordion(document.querySelector('.accordion'), {
  alwaysOpen: false
});
...
/* harmony import */ var _tel_mask_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tel-mask.js */ "./js/tel-mask.js");
/* harmony import */ var _tel_mask_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_tel_mask_js__WEBPACK_IMPORTED_MODULE_6__);
...
var input = document.querySelector('.form__input--name');
var modalWindow = document.querySelector('.modal');
var ModalWindow = /*#__PURE__*/function () {
  function ModalWindow(doc, modal) {
  ...
  _createClass(ModalWindow, [{
    ...
    value: function create() {
      ...
      var children = this.doc.body.children;
...
var modal = new ModalWindow(document, modalWindow);
